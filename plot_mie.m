...
for ii = 1:4 % air in adipose
    ...
    hold(ax1,'on');plot(ax1,3e14./(ff*1e12),qsca,colors(ii),'linewidth',1.5);
    hold(ax4,'on');plot(ax4,3e14./(ff*1e12),asy,colors(ii),'linewidth',1.5);    
end
...
for ii = 1:4 % air in epidermis
    ...
    hold(ax2,'on');plot(ax2,3e14./(ff*1e12),qsca,colors(ii),'linewidth',1.5);
    hold(ax5,'on');plot(ax5,3e14./(ff*1e12),asy,colors(ii),'linewidth',1.5);    
end
...
for ii = 1:4 % water in epidermis
    ...
    hold(ax3,'on');plot(ax3,3e14./(ff*1e12),qsca,colors(ii),'linewidth',1.5);
    hold(ax6,'on');plot(ax6,3e14./(ff*1e12),asy,colors(ii),'linewidth',1.5);    
end
